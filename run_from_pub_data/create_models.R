...
saveRDS(eaton_struc_m_scale, "models/eaton_struc_m1_scale.rda")
...
saveRDS(eaton_struc_m, "models/eaton_struc_m1_unscaled.rda")
...
saveRDS(Palisades_struc_m_scaled, "models/Palisades_struc_m1_scaled.rda")
...
saveRDS(Palisades_struc_m, "models/Palisades_struc_m1.rda")
